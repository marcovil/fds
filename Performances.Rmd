...
Faccio unnest_longer di soloists con opzione keep_empty per tenere anche le righe che contengono liste NULL e vedo che sono tutte liste di lunghezza 3, tranne alcune di lunghezza 0.
...
programsT %>%
  ...
  mutate(dateTime = parse_date_time(dtt, "%y-%m-%d %H:%M%p"))
