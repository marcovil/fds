...
Mi concentro sul periodo che va dal 2000 ad oggi.
...
concerti non-subscription, quelli molto presenti in un periodo limitato il tipo bandwagon.
...
Modelli in cui tutti e due le componenti sono negative.
...
Modelli in cui la parabola è positiva e la componente lineare è negativa. Primi 20 per componente lineare.
...
Modelli in cui la parabola è positiva e la componente lineare è negativa. Primi 20 per componente quadratica.
...
Modelli in cui la parabola è negativa e in cui la componente lineare cresce. Filtrati per componente lineare più grande.
...
Modelli in cui la parabola è negativa e in cui la componente lineare cresce. Filtrati per componente quadratica più grande.
...
Guardo ai residui più alti di 0.1
...
Gini compositori maggiore di 0.5. Compositori che nella stagione hanno più dell'10 percento delle performance.
...
ccn %>%
  inner_join(updown) %>%
  ggplot(aes(seasonN,n/condRep,color=type)) +
  geom_line() +
  facet_wrap(~conductorName)
```
