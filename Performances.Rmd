...
Un altro subset, compositori rappresentati prima della stagione 1909, per almeno 10 stagioni. Rappresentano il 76 % delle performance.
...
Prendo quelle che contengono almeno 3 osservazioni.
...
ccn2_glance_slopes <- ccn2_glance %>%
  ...
  arrange(estimate) %>%
  distinct(conductorName, composerName)
