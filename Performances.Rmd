...
Modfico aggiungendo una colonna che indica la presenza di co-conduzione.
...
perctime %>%
  inner_join(top, by = c("conductorName","composerName")) %>%
  ggplot(aes(year, perc, group = conductorName, color = composerName)) +
